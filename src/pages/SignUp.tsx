...
import { Leaf, Mail, Lock, User, Wallet, Gift, Loader2 } from 'lucide-react';
...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await signUp(email, password, username, referral || undefined, walletAddress || undefined);
      toast({
        title: 'Account created!',
        description: 'You can now start earning VINE tokens.',
      });
      navigate('/dashboard');
    } catch (error: any) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-vine-50/30 to-background">
      <Card className="w-full max-w-md shadow-vine">
        <CardHeader className="text-center space-y-2">
          ...
          <CardTitle className="text-2xl font-display">Join The Vine</CardTitle>
          <CardDescription>Start earning VINE tokens today</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="wallet">Solana Wallet (optional)</Label>
              <div className="relative">
